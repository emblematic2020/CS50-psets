...
int main(int argc, string argv[])
{
    ...
    // check  that its a non-negative integer
    if (cipher_key < 0)
    {
    ...
    // check that all of the characters in the argv[1] array are numbers
    ...
    // if one of the argv[1] array characters is not a number, return to main
